...
export const getGetUserPlaylistsQueryKey = () => {
  return [`/api/users/me/playlists`] as const;
};

export const getGetUserPlaylistsQueryOptions = <
  TData = Awaited<ReturnType<typeof getUserPlaylists>>,
  TError = unknown,
>(options?: {
  query?: Partial<
    UseQueryOptions<Awaited<ReturnType<typeof getUserPlaylists>>, TError, TData>
  >;
  ...
  > = ({ signal }) => getUserPlaylists(requestOptions, signal);
...
export type GetUserPlaylistsQueryResult = NonNullable<
  Awaited<ReturnType<typeof getUserPlaylists>>
>;
...
export const getJoinPlaylistMutationOptions = <
  TError = unknown,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type JoinPlaylistMutationResult = NonNullable<
  Awaited<ReturnType<typeof joinPlaylist>>
>;
 ...
 * @summary Join an existing playlist
 */
export const useJoinPlaylist = <TError = unknown, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof joinPlaylist>>,
      TError,
...
export const getLeavePlaylistMutationOptions = <
  TError = unknown,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type LeavePlaylistMutationResult = NonNullable<
  Awaited<ReturnType<typeof leavePlaylist>>
>;
 ...
 * @summary Leave playlist
 */
export const useLeavePlaylist = <TError = unknown, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof leavePlaylist>>,
      TError,
